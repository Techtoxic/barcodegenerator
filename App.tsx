    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-700 text-white p-4 sm:p-6 lg:p-8">
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-blue-500">
          GrindsquadKenya Barcode Generator
        </h1>
      ...
      <footer className="text-center text-slate-400 mt-12 py-4 border-t border-slate-700">
        <p className="text-lg font-semibold text-amber-400 mb-2">🇰🇪 Made with ❤️ and ☕ aesthetics</p>
        <p className="text-sm mb-2">Kenyan Made • GrindsquadKenya</p>
        <div className="flex justify-center space-x-4 text-xs">
          <a href="https://github.com/Techtoxic" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
            GitHub: Techtoxic
          </a>
          <span>•</span>
          <a href="https://wa.me/254114712455" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">
            WhatsApp: 254114712455
          </a>
          <span>•</span>
          <a href="https://t.me/technerdke" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 transition-colors">
            Telegram: technerdke
          </a>
        </div>
        <p className="text-xs mt-2 text-slate-500">Ensure data complies with AAMVA standards for correct barcode generation.</p>
      </footer>
    </div>
  );
};
